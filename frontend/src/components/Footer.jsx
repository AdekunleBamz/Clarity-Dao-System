...
const FOOTER_LINKS = {
  ...
  resources: [
    ...
    { label: 'GitHub', href: 'https://github.com/AdekunleBamz/Clarity-Dao-System' },
    { label: 'Blog', href: '#' },
  ],
  legal: [
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
              Decentralized governance for the Stacks ecosystem. Vote, stake, and participate in treasury management.
            </p>
